...
<video width="100%" controls>
  <source src="/blogs/206yingjian.assets/unicycle.mp4" type="video/mp4">
  你的浏览器暂不支持视频播放。
</video>
</center>

在智能车竞赛中，我们团队选择了极具挑战性的独轮组。虽然最终的比赛表现不尽人意，没有取得预期的成绩，但从机械结构、电路设计到平衡控制，整个备赛过程让我们积累了许多宝贵的经验。

<br>这辆独轮机器人也没有止步于一次比赛。基于竞赛中完成的设计和积累，我们后来成功拿下了**国家级大学生创新训练计划**，并发表了一篇**国际会议论文**。对于当时刚开始接触嵌入式开发和科研的我们来说，它虽然不是一个完美的作品，却是一个很好的起点。
