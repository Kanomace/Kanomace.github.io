...
- **AI 推理 / 边缘计算** → Raspberry Pi 4 / Jetson Nano，嵌入式 MCU 不擅长这个

---

嵌入式的学习没有捷径，**带着项目去踩坑**是最快的方式，比看十遍教程都管用。
